...
speakers, emotion_labels, sentiment_labels, sentences, train_ids, test_ids, valid_ids = pickle.load(open('meld.pkl', 'rb'))
...
pickle.dump([speakers, emotion_labels, sentiment_labels, roberta1, roberta2, roberta3, roberta4, sentences, train_ids, test_ids, valid_ids], open('meld_features_roberta.pkl', 'wb'))